...
| `{wk.module.sys}` | Absolute path to the Wake system modules in **current mode**. | `wake/runtime/module/w64-d/` |
...
| `{build.sys}` | Build system identifier for **current mode**. | `win64-d` |
